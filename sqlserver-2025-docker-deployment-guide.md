...
1. Download the SQL Server 2025 Image, Pull the latest stable release:
...
2. Deploy the SQL Server 2025 Container
...
4. 
a. Access SQL Server Inside the Container. SQL Server 2025 uses mssql-tools18:

bash
docker exec -it sql2025 bash

/opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P MyStrongPassword1! -C
...
b. Access SQL Server From Your Host. 

Using sqlcmd:

bash
sqlcmd -S localhost -U sa -P MyStrongPassword1!
